    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("user", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="votes", to="voting.customuser")),
            ],
            options={"ordering": ["-voted_at"]},
        ),
        migrations.AddConstraint(
            model_name="vote",
            constraint=models.UniqueConstraint(fields=("election", "user"), name="unique_vote_per_user_per_election"),
        ),
    ]
